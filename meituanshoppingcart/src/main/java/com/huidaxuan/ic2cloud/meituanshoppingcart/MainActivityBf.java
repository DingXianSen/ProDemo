...
public class MainActivityBf extends BaseActivity implements LeftProductTypeAdapter.onItemSelectedListener {
...
//                            Log.e(TAG, "onScrolled: "+headerLayout.getTranslationY()+"   "+headerLayout.getBottom()+"  -  "+headerLayout.getMeasuredHeight() );
    ...
    private void initListData() {
        ...
        //设置数据源，数据绑定展示
        leftAdapter = new LeftProductTypeAdapter(MainActivityBf.this, productListEntities);
        rightAdapter = new RightProductAdapter(MainActivityBf.this, productListEntities);
...
//   一、创造出执行动画的主题---imageview
        ...
        final ImageView goods = new ImageView(MainActivityBf.this);
...
//        layoutManager.scrollToPositionWithOffset(rightMenu, RecyclerView.SCROLL_STATE_DRAGGING, 0);
        leftClickType = true;
    }
}
