...
import com.huidaxuan.ic2cloud.meituanshoppingcart.scrollall.adapter.RightStoreOwnerZsypProductAdapter;
 ...
 * @description:门店详情-fragment——装饰用品-购物车加减操作
 * @author: dingchao
 * @time: 2020-11-20 13:23
 */
public class StoreDetailsZsypFragment extends BaseFragment implements View.OnClickListener, LeftProductTypeAdapter.onItemSelectedListener, ShopCartImp {
    /*购物车区域*/
    ...
    private RightStoreOwnerZsypProductAdapter rightAdapter;
...
//    RelativeLayout rl_bottom_shopping_cart;
    ...
    protected void fetchData() {
        ...
        rightAdapter = new RightStoreOwnerZsypProductAdapter(getActivity(), productListEntities, shopCart);
...
//   六、动画结束后的处理
    ...
    private void showTotalPrice(ProductListEntity.ProductEntity entity) {
        //todo通知购物车刷新数据
        if (shopCart != null) {
            EventBus.getDefault().post(new EventBusShoppingZxypEntity(shopCart, "ZsypUpdateCount"));
        }
