package com.huidaxuan.ic2cloud.selectlistdata.diy.popupwindow;
...
/**
 * @packageName:com.huidaxuan.ic2cloud.app2b.view.diy.popupwindow
 * @className: CommonPopupWindow
 * @description:popupWindow工具类
 * @author: dingchao
 * @time: 2020-07-02 17:42
 */
public abstract class CommonPopupWindow extends PopupWindow {
    ...
    public CommonPopupWindow(Context c, View view, int w, int h) {
        context = c;
        contentView = view;
