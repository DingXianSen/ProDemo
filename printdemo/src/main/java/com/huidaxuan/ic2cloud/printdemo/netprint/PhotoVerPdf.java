...
public class PhotoVerPdf {
     ...
     * @return
     */
    public boolean ready(String imgPath,String pdfPath) {
//        Log.e("ready", "------------imgPath--->:"+imgPath);
//        Log.e("ready", "------------pdfPath--->:"+pdfPath);
        //创建一个文档对象
        Document doc = new Document();
        try {
            File fileName = new File(pdfPath);
//            File fileName=new File(Environment.getExternalStorageDirectory()+"/netPrintTestPdf.pdf");
            Log.e("ready", "------------fileName--->:"+fileName);
            //定义输出文件的位置
...
//                Image jpg1 = Image.getInstance("/sdcard/myImage/" + i + ".png");
            Image jpg1 = Image.getInstance(imgPath);
//            Image jpg1 = Image.getInstance(Environment.getExternalStorageDirectory()+ "/netPrintTestPhoto.jpg");
            //原来的图片的路径
            //获得图片的高度
...
//    }
     ...
     * @param args
     */
    public void main3(String[] args,String imgPath,String pdfPath) {
        PhotoVerPdf pt = new PhotoVerPdf();
        pt.ready(imgPath,pdfPath);
//        pt.ready();
    }
}
